from libs.model.unet import ScaleAt
from libs.model.latentnet import *
from libs.diffusion.resample import UniformSampler
from libs.diffusion.diffusion import space_timesteps
...
from libs.diffusion.base import GenerativeType, LossType, ModelMeanType, ModelVarType, get_named_beta_schedule
from libs.model import *
from libs.choices import *

from multiprocessing import get_context
import os
from libs.dataset_util import *
...
class TrainConfig(BaseConfig):
    ...
    def make_T_sampler(self, define_t = None):
        if self.T_sampler == 'uniform':
            if define_t is None:
                return UniformSampler(self.T)
            else:
                return UniformSampler(define_t)
        else:
            raise NotImplementedError()
