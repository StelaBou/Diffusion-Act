...
def load_model(output_dir):
    ...
    # print(cfg.model)
    # print(cfg.model.pretrained_weights)
    cfg.model.pretrained_weights = '/home/stella/Desktop/projects/gitCodes/emoca/assets/FaceRecognition/resnet50_ft_weight.pkl'
    if 'emodeca_type' in cfg.model:
        model_class = class_from_str(cfg.model.emodeca_type, sys.modules[__name__])
    else:
        model_class = EmoDECA

    checkpoint = locate_checkpoint(cfg, mode="best") # cfg.model.deca_checkpoint
